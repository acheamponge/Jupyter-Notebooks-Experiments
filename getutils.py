# -*- coding: utf-8 -*-
"""
Created on Thu Jun 29 10:35:08 2017
...
def dump_csv(f, rows):
    keys = ['year_month', 'order_placed_tm', 'id', 'user', 'user_id', 'revenue', 'pcba_revenue', 'parts_revenue', 'other_revenue', 'units_ordered', 'is_bare_pcb', 'is_pcba', 'is_domestic', 'is_international', 'is_first_time_purchase', 'is_repeat_purchase', 'parts_per_unit', 'unique_parts_per_unit', 'board_area', 'seconds_since_user_registered', 'is_4layer_pcb', 'is_2layer_pcb']
